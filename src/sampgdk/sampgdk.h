...
/**
 * \ingroup natives
 * \see <a href="http://wiki.sa-mp.com/wiki/SetTimerEx">SetTimerEx on SA-MP Wiki</a>
 */
SAMPGDK_NATIVE(int, SetTimerEx(int interval, bool repeat, TimerCallback callback, void * param, void * owner));
...
/**
 * \ingroup natives
 * \see <a href="http://wiki.sa-mp.com/wiki/KillTimerEx">KillTimerEx on SA-MP Wiki</a>
 */
...
inline int SetTimerEx(int interval, bool repeat, TimerCallback callback, void * param, void * owner) {
  return sampgdk_SetTimerEx(interval, repeat, callback, param, owner);
}
...
inline bool KillTimerEx(int timerid, void * owner) {
  return sampgdk_KillTimerEx(timerid, owner);
}
...
#undef  KillTimerEx
#define KillTimerEx sampgdk_KillTimerEx
